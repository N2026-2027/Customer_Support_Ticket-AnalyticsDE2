{{ config(
    materialized='table',
    description="Tabla de hechos principal robusta. Incluye limpieza profunda, manejo de nulos y pre-cálculos de SLA.",
    labels={'department': 'customer_support', 'priority': 'high', 'quality_check': 'true'}
) }}
